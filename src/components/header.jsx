          ...
          <div className="uk-container uk-container-small uk-section">
            <div className="uk-text-center uk-text-bold">
              ...
              <span className="uk-label uk-label-primary uk-text-center uk-margin-small-bottom">
                {this.props.journal}
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Bandeira_do_Acre.svg/1200px-Bandeira_do_Acre.svg.png" alt="Bandeira do Acre" width="24" height="24"/>
              </span>
            </div>
            <Authors
